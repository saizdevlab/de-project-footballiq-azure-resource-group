...
Full step-by-step instructions — from creating the Azure Resource Group through connecting Power BI — are in [`docs/FootballIQ_Azure_Setup_Manual.pdf`](docs/FootballIQ_Azure_Setup_Manual.pdf).
